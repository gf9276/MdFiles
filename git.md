...
- [1. git.md](#1-gitmd)
- [2. git 指令](#2-git-指令)
  - [2.1. ubuntu下静止自动转成crlf](#21-ubuntu下静止自动转成crlf)
  - [2.2. 设置全局代理](#22-设置全局代理)
  - [2.3. 查看修改git账户信息](#23-查看修改git账户信息)
  ...
  - [2.7. 版本管理](#27-版本管理)
    ...
    - [2.7.3. 选择指定id的版本（可以用于回退或者恢复）](#273-选择指定id的版本可以用于回退或者恢复)
